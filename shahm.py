...
async def join_channel(event):
	try :
		await ha313so(JoinChannelRequest('@SHA_HM1'))
	except BaseException:
		pass		
@ha313so.on(events.NewMessage)
async def join_channel(event):
	try:
		await ha313so(JoinChannelRequest('@SHA_HM2'))
	except BaseException :
		pass
@ha313so.on(events.NewMessage)
async def join_channel(event):
	try:
		await ha313so(JoinChannelRequest('@Super_Shahm'))
	except BaseException :
		pass
...
async def join_channel(event):
	try:
		await ha313so(JoinChannelRequest('@BGGlG'))
	except BaseException :
		pass
yaAli = False
